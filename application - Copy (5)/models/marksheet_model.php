...
$condition = "student_sem.student_id ='".$data."' and student_sem.sem='".$sem."' and student_sem.session='".$session."' and student_admit.sem='".$sem."' and student_admit.session='".$session."' and student_admit.review!='X'";	
...
$condition = "result.student_id ='".$data."' and result.sem='".$sem."' and result.session='".$session."'";

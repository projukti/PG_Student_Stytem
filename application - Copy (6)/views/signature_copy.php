...
<a href="<?php echo base_url() . "index.php/viewexam"; ?>"><input type="button" value="Back" style="font:bold 11px verdana;color:#FF0000;background-color:#FFFFFF;" /></a>
    ...
    <div class="logo" align="center">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><strong>Exam Date:</strong> <?php  echo date("d/m/Y",strtotime($date));  ?></td>
  ...
  <tr>
    ...
    <?php if(!empty($show_student)){ 
	$i=0; foreach($show_student as $student) { $i++; 
	?>
  <tr>
    <td><?php echo $i;?></td>
  ...
  <?php }}else{?>
   <h5 style="color:green;">No data found</h5> 
   <?php }?>
      </table>

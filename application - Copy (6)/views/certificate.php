...
<style>
	.page_a4_body
	{
		...
		margin:0px auto;
		background:url(<?php echo base_url()?>/images/cu.png) no-repeat;
...
<?php foreach($student_details as $student) { ?>
	<div class="page_a4_body" align="center">
      ...
      <div class="cer_con">
      <h3 style="font-size:24px;"> This is to certify that <span style="font-size:40px;text-transform: capitalize;font-family: 'Marck Script', cursive;padding-left:10px;"> <?php echo $student->name; ?></span><br /> <br />obtained the degree of </h3>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" >
          <tr>
            <td align="left">Senate House<br />The 30th November,2012</td>
            <td align="right">Vice-Chancellor</td>
        </tr>
      </table>
<?php }?>
    </div>

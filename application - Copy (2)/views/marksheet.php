      ...
      <P style="text-align:left;">Remarks:'N.C.' Denotes Not Cleared Paper/s<br />* A minimum of 35% marks to be obtained in each paper and 40% marks to be obtained in aggregate.</P>
    	<table width="100%" border="1" cellspacing="0" cellpadding="2" class="my_table">
          ...
          <tr>
            ...
            <td><?php echo $data['result1'] = $this->marksheet_model->result_i($id,'1st');?></td>
            <td><?php echo $data['result2'] = $this->marksheet_model->result_i($id,'2nd');?></td>
           	<td><?php echo $data['result3'] = $this->marksheet_model->result_i($id,'3rd');?></td>
            <td><?php echo $data['result4'] = $this->marksheet_model->result_i($id,'4th');?></td>
            <td>1000</td>

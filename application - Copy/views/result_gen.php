                     ...
                     <div class="form_box">
                          ...
                          <div class="form_row">
                           ...
                           <input type="hidden" name="subject_id[]" value="<?php echo $student_subject->subject_id; ?>">
                            ...
                            <div style=" width:10%; float:left;"><input type="checkbox" name="is_absent[]" value="1"></div>
                           </div>
                     ...
                     <div class="form_box">
                          ...
                          <div class="form_row">
                           ...
                           <input type="hidden" name="subject_id[]" value="<?php echo $student_subject->subject_id; ?>">
                            ...
                            <div style=" width:10%; float:left;"><input type="checkbox" name="is_absent[]" value="1" <?php if($student_subject->is_absent==1){echo 'checked';}?>></div>
                           </div>
                        <input type="hidden" id="sem" name="sem" value="<?php echo $student_subject->sem; ?>">   
                             <?php endforeach; ?>

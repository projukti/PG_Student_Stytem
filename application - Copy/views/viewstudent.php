	 ...
	 ?>
			...
			<?php if(isset($search_student)){?>
                        ...
                        <div class="row">
                            ...
                            <?php /*?><div class="cell"><a href="<?php echo base_url() . "index.php/viewstudent/delete_student/" . $student->id; ?>">Delete</a></div><?php */?>
							<?php }?>
                        </div>
                        <?php }} ?>
                    </div>                    
                    <?php }else{?>  
                        ...
                        <div class="row">
                            ...
                            <div class="cell"><?php echo $student->caste; ?></div>
                             ...
                             <?php if($access==1){?>
                            <div class="cell"><a href="<?php echo base_url() . "index.php/viewstudent/show_student_id/" . $student->id; ?>">Edit</a></div>
                            <?php /*?><div class="cell"><a href="<?php echo base_url() . "index.php/viewstudent/delete_student/" . $student->id; ?>">Delete</a></div><?php */?><?php }?>
                        </div>
                        <?php } ?>
                        <div id="pagination">

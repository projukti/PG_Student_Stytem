...
$count_std=$this->db->query("select * from student where cu_reg_no='".$this->input->post('cu_reg_no')."'")->num_rows();	 
if($count_std==0){  
...
else{$data['messageerr'] = 'Sorry!!! Data Already Found with given Register Number';}
}

<?php
   ...
   <div class="main_body">        	
            	<div class="main_container">
                    ...
                    <h5 style="color:green; font-size:14px;" align="center"><?php echo $message;?></h5><br><?php } ?>
                    <?php if (isset($messageerr)) { ?>
                    <h5 style="color:#F00; font-size:14px;" align="center"><?php echo $messageerr;?></h5><br><?php } ?>
                		<h2>Add Student</h2>
